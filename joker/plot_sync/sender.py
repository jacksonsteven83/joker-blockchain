...
from joker.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
...
from joker.server.ws_connection import NodeType, ProtocolMessageTypes, WSJokerConnection, make_msg
...
class Sender:
    ...
    _connection: Optional[WSJokerConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSJokerConnection) -> None:
