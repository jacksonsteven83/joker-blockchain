...
from joker.plot_sync.exceptions import (
...
from joker.plot_sync.util import ErrorCodes, State
...
from joker.util.ints import int16, uint32, uint64
...
class Receiver:
    ...
    def connection(self) -> WSJokerConnection:
