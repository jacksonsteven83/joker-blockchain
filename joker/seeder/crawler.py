...
from joker.seeder.crawl_store import CrawlStore
from joker.seeder.peer_record import PeerRecord, PeerReliability
...
class Crawler:
    ...
    async def connect_task(self, peer):
        async def peer_action(peer: ws.WSJokerConnection):
