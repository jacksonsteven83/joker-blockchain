...
p2_delegated_puzzle_or_hidden_puzzle is essentially the "standard coin" in joker.
...
- The user's wallet contains a primary sk/pk pair which are used to derive to one
  ...
  https://jokerlisp.com/docs/standard_transaction. Therefore, when a wallet needs
...
- Python code previously appeared which was written like:
  ...
  In context, delegated_puzzle_solution here is any *jokerlisp program*, here one
  ...
  The second and third arguments are a jokerlisp program and its corresponding
