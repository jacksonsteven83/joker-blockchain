...
from joker.wallet.nft_wallet.nft_info import NFTCoinInfo, NFTInfo
from joker.wallet.nft_wallet.uncurry_nft import UncurriedNFT
from joker.wallet.puzzles.load_clvm import load_clvm
from joker.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import solution_for_conditions
...
def metadata_to_program(metadata: Dict[bytes, Any]) -> Program:
    """
    Convert the metadata dict to a Jokerlisp program
    :param metadata: User defined metadata
    :return: Jokerlisp program
    """
    kv_list = []
...
def program_to_metadata(program: Program) -> Dict[bytes, Any]:
    ...
    :param program: Jokerlisp program contains the metadata
