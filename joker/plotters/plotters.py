...
from joker.plotters.chiapos import get_chiapos_install_info, plot_chiapos
...
def call_plotters(root_path: Path, args):
    ...
    build_parser(subparsers, root_path, chiapos_plotter, "chiapos", "Chiapos Plotter")
    ...
    if args.plotter == "chiapos":
        plot_chiapos(args, joker_root_path)
