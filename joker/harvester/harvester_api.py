...
from joker.protocols.harvester_protocol import Plot, PlotSyncResponse
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSJokerConnection
    ):
        """
