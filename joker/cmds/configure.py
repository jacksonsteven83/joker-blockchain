...
from joker.util.config import lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, "config.yaml") as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "56888"
                testnet_introducer = "introducer-testnet10.jokercoin.org"
                testnet_dns_introducer = "dns-introducer-testnet10.jokercoin.org"
                bootstrap_peers = ["testnet10-node.jokercoin.org"]
                testnet = "testnet10"
                ...
                bootstrap_peers = ["node.jokercoin.org"]
                net = "mainnet"
