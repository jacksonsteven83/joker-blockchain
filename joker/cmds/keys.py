...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Joker versions use "
...
@keys_cmd.command("migrate", short_help="Attempt to migrate keys to the Joker keyring")
@click.pass_context
...
@click.option("--prefix", "-x", help="Address prefix (xjk for mainnet, txjk for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
