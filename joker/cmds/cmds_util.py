...
from joker.types.mempool_submission_status import MempoolSubmissionStatus
...
def transaction_status_msg(fingerprint: int, tx_id: bytes32) -> str:
    return f"Run 'joker wallet get_transaction -f {fingerprint} -tx 0x{tx_id}' to get status"
