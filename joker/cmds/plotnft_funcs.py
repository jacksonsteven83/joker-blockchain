...
from joker.pools.pool_config import load_pool_config, PoolWalletConfig, update_pool_config
...
from joker.util.bech32m import encode_puzzle_hash, decode_puzzle_hash
...
async def create(args: dict, wallet_client: WalletRpcClient, fingerprint: int) -> None:
    ...
    if user_input.lower() == "y" or user_input.lower() == "yes":
        try:
            ...
            print(f"Error creating plot NFT: {e}\n    Please start both farmer and wallet with:  joker start -r farmer")
        return
    print("Aborting.")
