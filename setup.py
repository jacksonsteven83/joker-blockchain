...
dependencies = [
    ...
    "setproctitle==1.2.3",  # Gives the joker processes readable names
...
kwargs = dict(
    ...
    packages=[
        ...
        "joker.wallet.cat_wallet",
        "joker.wallet.did_wallet",
        "joker.wallet.nft_wallet",
    ...
    entry_points={
        "console_scripts": [
            ...
            "joker_daemon = joker.daemon.server:main",
            ...
            "joker_crawler = joker.seeder.start_crawler:main",
            "joker_seeder = joker.seeder.dns_server:main",
