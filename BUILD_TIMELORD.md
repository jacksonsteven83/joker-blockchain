...
required to run a [Timelord](https://github.com/Joker-Network/joker-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Joker-Network/joker-blockchain/blob/main/install-timelord.sh)
