...
def update_version(package_json_path: str):
    ...
    data["version"] = get_joker_version()
...
if __name__ == "__main__":
    update_version(f"{os.path.dirname(__file__)}/joker-blockchain-gui/package.json")
    update_version(f"{os.path.dirname(__file__)}/joker-blockchain-gui/packages/gui/package.json")
