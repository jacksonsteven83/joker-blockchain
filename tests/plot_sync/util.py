...
from joker.protocols.harvester_protocol import PlotSyncIdentifier
from joker.server.start_service import Service
from joker.server.ws_connection import Message, NodeType
...
def get_dummy_connection(node_type: NodeType, peer_id: Optional[bytes32] = None) -> WSJokerConnectionDummy:
    return WSJokerConnectionDummy(node_type, bytes32(token_bytes(32)) if peer_id is None else peer_id)
