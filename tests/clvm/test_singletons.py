...
from joker.wallet.puzzles import p2_conditions, p2_delegated_puzzle_or_hidden_puzzle
...
This test suite aims to test:
    ...
    - joker.wallet.puzzles.singleton_top_layer_v1_1.py
    ...
    async def test_singleton_top_layer(self, version):
        try:
            ...
            if version == 0:
                ...
                from joker.wallet.puzzles import singleton_top_layer_v1_1 as singleton_top_layer
