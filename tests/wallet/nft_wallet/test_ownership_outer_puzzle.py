...
from joker.wallet.nft_wallet.ownership_outer_puzzle import puzzle_for_ownership_layer
from joker.wallet.nft_wallet.transfer_program_puzzle import puzzle_for_transfer_program
