...
from joker.wallet.cat_wallet.cat_wallet import CATWallet
from joker.wallet.outer_puzzles import AssetType
from joker.wallet.puzzle_drivers import PuzzleInfo
from joker.wallet.trading.offer import Offer
...
class TestCATTrades:
    ...
    async def test_cat_trades(self, wallets_prefarm):
        ...
        MAKER_JOKER_BALANCE = 20 * 1000000000000 - 100
        TAKER_JOKER_BALANCE = 20 * 1000000000000 - 100
        await time_out_assert(25, wallet_maker.get_confirmed_balance, MAKER_JOKER_BALANCE)
        await time_out_assert(25, wallet_taker.get_unconfirmed_balance, TAKER_JOKER_BALANCE)
        ...
        # joker_for_cat
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(joker_for_cat, fee=uint64(1))
        await asyncio.sleep(1)
        ...
        MAKER_JOKER_BALANCE -= 2  # -1 and -1 for fee
        MAKER_NEW_CAT_BALANCE += 2
        TAKER_JOKER_BALANCE += 0  # +1 and -1 for fee
        TAKER_NEW_CAT_BALANCE -= 2

        await time_out_assert(15, wallet_taker.get_unconfirmed_balance, TAKER_JOKER_BALANCE)
        ...
        await time_out_assert(15, wallet_maker.get_confirmed_balance, MAKER_JOKER_BALANCE)
        await time_out_assert(15, wallet_maker.get_unconfirmed_balance, MAKER_JOKER_BALANCE)
        ...
        await time_out_assert(15, wallet_taker.get_confirmed_balance, TAKER_JOKER_BALANCE)
        await time_out_assert(15, wallet_taker.get_unconfirmed_balance, TAKER_JOKER_BALANCE)
        ...
        # cat_for_joker
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(cat_for_joker)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        MAKER_CAT_BALANCE -= 4
        MAKER_JOKER_BALANCE += 3
        TAKER_CAT_BALANCE += 4
        TAKER_JOKER_BALANCE -= 3
        ...
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(
            joker_for_multiple_cat, driver_dict=driver_dict
        )
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        ...
        MAKER_JOKER_BALANCE -= 7
        MAKER_CAT_BALANCE += 8
        MAKER_NEW_CAT_BALANCE += 9
        TAKER_JOKER_BALANCE += 7
        TAKER_CAT_BALANCE -= 8
        ...
        # multiple_cat_for_joker
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(multiple_cat_for_joker)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        MAKER_JOKER_BALANCE += 10
        TAKER_CAT_BALANCE += 11
        TAKER_NEW_CAT_BALANCE += 12
        TAKER_JOKER_BALANCE -= 10
        ...
        # joker_and_cat_for_cat
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(joker_and_cat_for_cat)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
        ...
        MAKER_JOKER_BALANCE -= 13
        MAKER_CAT_BALANCE -= 14
        MAKER_NEW_CAT_BALANCE += 15
        TAKER_JOKER_BALANCE += 13
    ...
    async def test_trade_cancellation(self, wallets_prefarm):
        ...
        MAKER_JOKER_BALANCE = 20 * 1000000000000 - 100
        MAKER_CAT_BALANCE = 100
        TAKER_JOKER_BALANCE = 20 * 1000000000000
        await time_out_assert(15, wallet_maker.get_confirmed_balance, MAKER_JOKER_BALANCE)
        ...
        await time_out_assert(15, wallet_maker.get_confirmed_balance, MAKER_JOKER_BALANCE - FEE)
        await time_out_assert(15, cat_wallet_maker.get_confirmed_balance, MAKER_CAT_BALANCE)
        await time_out_assert(15, wallet_taker.get_confirmed_balance, TAKER_JOKER_BALANCE)
        ...
        success, trade_make, error = await trade_manager_maker.create_offer_for_ids(joker_for_cat)
        await asyncio.sleep(1)
        assert error is None
        assert success is True
        assert trade_make is not None
