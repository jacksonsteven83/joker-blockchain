...
from joker.wallet.util.wallet_types import AmountWithPuzzlehash
...
class TestWalletSimulator:
    ...
    async def test_wallet_coinbase(
        self,
        wallet_node_sim_and_wallet: Tuple[List[FullNodeSimulator], List[Tuple[WalletNode, JokerServer]]],
        trusted: bool,
        self_hostname: str,
    ) -> None:
        num_blocks = 10
    ...
    async def test_wallet_make_transaction(
        self,
        two_wallet_nodes: Tuple[List[FullNodeSimulator], List[Tuple[WalletNode, JokerServer]]],
        trusted: bool,
        self_hostname: str,
    ) -> None:
        num_blocks = 5
    ...
    async def test_wallet_send_to_three_peers(
        self,
        three_sim_two_wallets: Tuple[List[FullNodeSimulator], List[Tuple[WalletNode, JokerServer]]],
        trusted: bool,
        self_hostname: str,
    ) -> None:
        num_blocks = 10
    ...
    async def test_wallet_make_transaction_hop(
        self,
        two_wallet_nodes_five_freeze: Tuple[List[FullNodeSimulator], List[Tuple[WalletNode, JokerServer]]],
        trusted: bool,
        self_hostname: str,
    ) -> None:
        num_blocks = 10
    ...
    async def test_address_sliding_window(
        self,
        wallet_node_100_pk: Tuple[List[FullNodeSimulator], List[Tuple[WalletNode, JokerServer]]],
        trusted: bool,
        self_hostname: str,
    ) -> None:
