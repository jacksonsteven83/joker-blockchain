...
# https://github.com/Joker-Network/joker-blockchain/pull/10460#issuecomment-1054492495
...
if [ ! "$CI" ]; then
  ...
  # Set modified output of `joker version` to version property of GUI's package.json
