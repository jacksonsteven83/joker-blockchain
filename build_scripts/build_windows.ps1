...
Write-Output "   ---"
Copy-Item "dist\daemon" -Destination "..\joker-blockchain-gui\packages\gui\" -Recurse
...
Write-Output "   ---"
Copy-Item ".\Joker-win32-x64" -Destination "$env:GITHUB_WORKSPACE\joker-blockchain-gui\" -Recurse
Copy-Item ".\release-builds" -Destination "$env:GITHUB_WORKSPACE\joker-blockchain-gui\" -Recurse
