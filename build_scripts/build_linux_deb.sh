...
export JOKER_INSTALLER_VERSION
...
pip install j2cli
CLI_DEB_BASE="joker-blockchain-cli_$JOKER_INSTALLER_VERSION-1_$PLATFORM"
mkdir -p "dist/$CLI_DEB_BASE/opt/joker"
mkdir -p "dist/$CLI_DEB_BASE/usr/bin"
mkdir -p "dist/$CLI_DEB_BASE/DEBIAN"
j2 -o "dist/$CLI_DEB_BASE/DEBIAN/control" assets/deb/control.j2
cp -r dist/daemon/* "dist/$CLI_DEB_BASE/opt/joker/"
ln -s ../../opt/joker/joker "dist/$CLI_DEB_BASE/usr/bin/joker"
...
electron-installer-debian --src "dist/$DIR_NAME/" \
  --arch "$PLATFORM" \
  --options.version "$JOKER_INSTALLER_VERSION" \
