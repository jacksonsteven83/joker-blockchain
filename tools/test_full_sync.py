...
from joker.cmds.init_funcs import joker_init
...
async def run_sync_test(
    ...
    with tempfile.TemporaryDirectory() as root_dir:
        ...
        joker_init(root_path, should_check_keys=False, v1_db=(db_version == 1))
        ...
        try:
            ...
            peer: ws.WSJokerConnection = FakePeer()  # type: ignore[assignment]
